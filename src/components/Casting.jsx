...
import trashIcon from "../assets/Delete.svg"; // Import the trash icon image
...
import ViewApplications from "../components/ViewApplications"; // Adjust the path as needed
export default function CastingCalls() {
  ...
  const handleDelete = () => {
    // Here you would typically make an API call to delete the casting call
    console.log("Deleting casting call:", castingCalls[selectedCasting].id);
    setShowDeleteModal(false);
    
    // In a real app, you would update your state or refetch data after deletion
  ...
  return (
    <div className="h-screen w-full bg-white text-black flex flex-col gap-4 overflow-hidden">
      ...
      <div className="flex justify-between items-center px-4">
        <div className="gap-4 flex grid-cols-3">
          <button
            ...
            onClick={() => setActiveTab("castingCalls")}
          >
            <img
  ...
  onClick={() => {
    ...
    console.log("Create Casting Call button clicked, showCreateModal:", true);
  }}
>
  ...
  Create Casting Call
      ...
      <div className="flex flex-1 gap-4 overflow-hidden">
        {activeTab === "castingCalls" && (
          <div className="flex flex-1 gap-4 overflow-hidden">
            {/* Left Sidebar */}
            <div className="w-1/3 border-r shadow overflow-y-auto scrollbar-hide h-full bg-white">
            ...
            <div className="flex-1 border shadow p-6 space-y-4 scrollbar-hide overflow-y-auto">
              {castingCalls.length > 0 && (
                <>
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      className="bg-black text-white px-4 py-2 ml-80 rounded-3xl"
